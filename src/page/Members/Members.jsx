  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3, width: { sm: `calc(100% - ${drawerWidth}px)` } }}>
        <Toolbar />
        <h1 style={{ marginBottom: '20px', marginLeft: '10px' }}>Members</h1>
        <Card sx={{ p: 3, m: 2, borderRadius: 3, boxShadow: 3, backgroundColor: '#fff',width:1100 }}>
          <Grid container spacing={2} sx={{ marginLeft: '10px', marginTop: '10px' }}>
            <Grid item xs={6}>
              <UserInput val="Name" name="" />
            </Grid>
            <Grid item xs={6} sx={{ marginTop: '80px', marginTop: '-10px' }}>
              <UserInput val="M-Id" name="" />
            </Grid>
            <Grid item xs={6} sx={{ marginTop: '80px', marginTop: '20px' }}>
              <UserInput val="Phone-Number" name="" />
            </Grid>
            <Grid item xs={6} sx={{ marginTop: '20px', marginBottom: 7 }}>
              <UserInput val="Address" name="" />
            </Grid>
          </Grid>

          <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
            <Box>
              <Typography sx={{ mr: 2,marginLeft:5 }}><h2>Male or Female:</h2></Typography>
              <Button variant="outlined" sx={{ marginLeft: 5,color:'black',borderRadius:20,width:120 }}>Male</Button>
              <Button variant="outlined" sx={{ marginLeft: 10,color:'black',borderRadius:20,width:120  }}>Female</Button>
            </Box>
            <Box>
              <Typography sx={{ mr: 43 }}><h2>Body Details</h2></Typography>
              <Button variant="contained" sx={{ color:'white',borderRadius:20,width:120  }}>Show All</Button>
            </Box>
