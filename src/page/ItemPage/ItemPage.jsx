      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3, width: { sm: `calc(100% - ${drawerWidth}px)` } }}>
        ...
        <Card sx={{ p: 3, m: 2, borderRadius: 3, boxShadow: 3, backgroundColor: '#fff',width:1100 }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
            <Box>
              <Typography sx={{ mr: 2,marginLeft:5 }}><h2>Status</h2></Typography>
              <Button variant="outlined" sx={{ marginLeft: 5,color:'black',borderRadius:20,width:120  }}>Good</Button>
              <Button variant="outlined" sx={{ marginLeft: 5,color:'black',borderRadius:20,width:120  }}>Normal</Button>
              <Button variant="outlined" sx={{ marginLeft: 5,color:'black',borderRadius:20,width:120  }}>Poor</Button>
